...
import { addComment, createPost, getAllPosts, getPostById, voteOnPoll, getUserProfilePosts, getTrendingPosts, replyToComment, toggleLike, toggleTrendingStatus, getUserPosts, getAllPostsAuthor } from '../controllers/post.controller.js';
...
router.get('/all-posts/:authorId', getAllPostsAuthor);
