...
import { register, login, updateProfile,addCampaign,listAllCampaigns,editEducation,updateExperiences,deleteExperience,updateEducation,deleteEducation, viewProfile, getAllProfiles, editExperience, editCampaign, deleteCampaign, getRandomSuggestedProfiles } from '../controllers/marketer.controller.js';
...
/profiles/random-suggested
router.get('/profile/:id', viewProfile);
router.get('/profiles/random-suggested', getRandomSuggestedProfiles);
