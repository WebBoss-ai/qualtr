                ...
                <div className="container mx-auto px-4 py-8 bg-gray-50">
                    <div className="w-full mt-6 mb-6 p-4">
                        <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 rounded-3xl mb-16">
                            ...
                            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 p-8 lg:p-16">
                                <div className="flex-1 space-y-8">
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        <button className="group bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg text-sm transition-all duration-300 hover:shadow-lg flex items-center space-x-2">
                                        ...
                                        <button
                                            ...
                                            className="group bg-white text-emerald-600 border-2 border-emerald-600 hover:bg-emerald-50 px-6 py-3 rounded-lg text-sm transition-all duration-300 flex items-center space-x-2"
                                        >
                            ...
                            <div className="absolute bottom-4 right-8 bg-emerald-100 text-emerald-800 px-6 py-3 rounded-full text-lg animate-pulse">
