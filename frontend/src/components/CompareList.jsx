            ...
            {compareList.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {compareList.map((agency) => (
                        <div key={agency._id} className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                            <div className="p-6">
                                <div className="flex items-center mb-6">
                                    <img 
                                        src={agency.profile.profilePhoto || "/placeholder.svg?height=80&width=80"} 
                                        alt={agency.profile.agencyName}
                                        className="w-20 h-20 rounded-full object-cover mr-4 border-4 border-[#17B169]" 
                                    />
                                    <div>
                                ...
                                <button
                                    ...
                                    className="mt-6 w-full bg-[#17B169] text-white py-3 px-4 rounded-lg hover:bg-[#149655] transition-colors duration-300 flex items-center justify-center font-semibold text-lg shadow-md hover:shadow-lg"
                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {agency.profile.expertise?.map((experty, index) => (
                                                <span key={index} className="bg-gradient-to-r from-[#17B169] to-[#1FD180] text-white px-3 py-1 rounded-full text-sm font-medium shadow-sm transition-all duration-300 hover:shadow-md hover:scale-105">{experty}</span>
                                            ))}
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {agency.profile.servicesOffered?.map((service, index) => (
                                                <span key={index} className="bg-white text-[#17B169] border-2 border-[#17B169] px-3 py-1 rounded-full text-sm font-medium shadow-sm transition-all duration-300 hover:bg-[#17B169] hover:text-white">{service}</span>
                                            ))}
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {agency.profile.industries?.map((industry, index) => (
                                                <span key={index} className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-medium shadow-sm transition-all duration-300 hover:bg-gray-200">{industry}</span>
                                            ))}
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        {agency.profile.portfolio?.length > 0 ? (
                                            <ul className="space-y-4">
                                                {agency.profile.portfolio.map((item, index) => (
                                                    <li key={index} className="bg-gray-50 p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
                                                        <p
