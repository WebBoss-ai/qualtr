...
const VCList = () => {
    ...
    const categories = {
        ...
        "Aerospace / Space-tech": ["Aerospace / Space-tech", "Hard Tech"],
        "Agriculture / Agri-tech": ["Agriculture / Agri-tech", "Sustainability"],
        "Analytics": ["Analytics", "B2B SaaS", "Enterprise"],
        "B2B SaaS": ["B2B SaaS", "Enterprise", "Developer Tools", "Sales Enablement"],
        "Biotech": ["Biotech", "Healthcare", "Medical Devices"],
        "Community": ["Community", "Media", "Wellness"],
        "Construction": ["Construction", "Real Estate / Prop-tech"],
        "Continuing Education": ["Continuing Education", "K-12", "Language Learning"],
        "Crypto / Blockchain / Web3": ["Crypto / Blockchain / Web3", "Financial Services", "Security"],
        "Energy": ["Energy", "Sustainability"],
        "Developer Tools": ["Developer Tools", "B2B SaaS", "Enterprise"],
        "Entertainment": ["Entertainment", "Gaming", "Media"],
        "Financial Services": ["Financial Services", "Fintech", "Insurance"],
        "Fitness": ["Fitness", "Wellness", "Healthcare"],
        "Food/Beverage": ["Food/Beverage", "Retail", "Consumer"],
        "Freight": ["Freight", "Transportation", "Logistics"],
        "Government": ["Government", "Security", "Analytics"],
        "Gaming": ["Gaming", "Entertainment", "Virtual Reality / AR"],
        "Hard Tech": ["Hard Tech", "Robotics", "Aerospace / Space-tech"],
        "Hardware": ["Hardware", "Hard Tech", "Robotics"],
        "Healthcare": ["Healthcare", "Medical Devices", "Mental Health"],
        "Insurance": ["Insurance", "Financial Services", "Healthcare"],
        "K-12": ["K-12", "Continuing Education", "Language Learning"],
        "Language Learning": ["Language Learning", "Education"],
        "Marketplace": ["Marketplace", "E-commerce", "Retail"],
        "Media": ["Media", "Entertainment", "Community"],
        "Medical Devices": ["Medical Devices", "Healthcare", "Biotech"],
        "Mental Health": ["Mental Health", "Healthcare", "Wellness"],
        "Other": ["Other"],
        "Real Estate / Prop-tech": ["Real Estate / Prop-tech", "Construction"],
        "Recruiting / HR-tech": ["Recruiting / HR-tech", "B2B SaaS"],
        "Retail": ["Retail", "E-commerce", "Marketplace"],
        "Robotics": ["Robotics", "Hardware", "Hard Tech"],
        "Sales Enablement": ["Sales Enablement", "B2B SaaS", "Enterprise"],
        "Security": ["Security", "Government", "Crypto / Blockchain / Web3"],
        "Sustainability": ["Sustainability", "Energy", "Agriculture / Agri-tech"],
        "Transportation": ["Transportation", "Freight", "Travel/Tourism"],
        "Travel/Tourism": ["Travel/Tourism", "Transportation"],
        "Virtual Reality / AR": ["Virtual Reality / AR", "Gaming", "Entertainment"],
        "Wellness": ["Wellness", "Mental Health", "Fitness"]
    };
        ...
        if (selectedCategories.length > 0) {
            filtered = filtered.filter(vc =>
                selectedCategories.some(selected =>
                    (categories[selected] || []).some(mappedCategory =>
                        vc.categoriesOfInterest.includes(mappedCategory)
                    )
                )
            );
        }
