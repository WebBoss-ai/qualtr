...
const SalesCustomerAcquisitionPosts = () => {
...
const categories = [
    ...
    const fetchPosts = async () => {
        ...
        try {
            // Fetch all posts
            const response = await axios.get(`${MARKETER_API_END_POINT}/posts/sales-customer-acquisition`);
...
export default SalesCustomerAcquisitionPosts;
